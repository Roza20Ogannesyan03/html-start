...
const paths = {
  styles: {
    src: ["app/libs/**/*.css", "app/template/**/*.sass", "app/template/**/*.scss", "app/template/**/*.css", "app/sass/**/*.sass", "app/sass/**/*.scss", "app/sass/**/*.css"],
    dest: "app/css",
  },
  scripts: {
    src: ["app/libs/**/*.js", "app/template/**/*.js", "app/js/app.js"],
    dest: "app/js",
  },
  images: {
    src: "app/images/src/**/*",
...
function minifyScripts() {
  return src(paths.scripts.src).pipe(concat("app.min.js")).pipe(terser()).pipe(dest(paths.scripts.dest)).pipe(browsersync.stream());
}
...
// Сборка проекта
exports.build = parallel(exports.styles, exports.scripts, exports.images, exports.sprite, exports.fonts);
